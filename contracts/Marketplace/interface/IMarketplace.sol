...
import { ListedAssetInfo, BaseAssetIdentifiers, IERC20 } from "contracts/lib/structs.sol";
...
interface IMarketplace is GenericErrors {
    ...
    event AssetListed(
        ...
        ListedAssetInfo listedAssetInfo
    );
     ...
     * @param listedAssetInfos, information of listed asset including salePrice, listedFraction, minFraction and token sale
     */
    function batchList(
        uint256[] calldata mainIds,
        uint256[] calldata subIds,
        ListedAssetInfo[] calldata listedAssetInfos
    ) external;
    ...
    /**
     * @dev Gets current base asset collection address
     ...
     * @param assetMainId, unique identifier of asset type
     * @param assetSubId, unique identifier of asset
     * @return listedAssetInfo struct
     */
